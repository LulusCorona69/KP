...
$jur_ia = select("*", "tbl_kelas", "paket = 'IPA'");
$jur_is = select("*", "tbl_kelas", "paket = 'IPS'");

$ia = mysqli_num_rows($jur_ia);
$is = mysqli_num_rows($jur_is);
?>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      function PackageChart(){
        ...
        var options = {
          title : 'Grafik Data Jurusan',
		    colors : ['#f29ba2', '#c182f2'],
          is3D : true
        }
